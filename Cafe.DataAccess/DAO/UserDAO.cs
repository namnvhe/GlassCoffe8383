...
namespace Cafe.DataAccess.DAO
{
    public class UserDAO
    {
        ...
        public UserDAO(CoffeManagerContext context, IWebHostEnvironment environment)
        {
        ...
        public async Task<ApiResponse<bool>> UpdateProfileAsync(int userId, string fullName, string phone, string? photoPath)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(photoPath))
                {
                    ...
                    {
                        var oldPhotoPath = Path.Combine(_environment.WebRootPath, user.PhotoPath.TrimStart('/'));
